...
class client {
    ...
    async messages(channel_id, queries) {
        // ex: ?before=1047560263991300160&limit=50
        const url = https.build_query(`https://canary.discord.com/api/v9/channels/${channel_id}/messages`, queries)
        const result = await discord_request(this.authorization, `get`, url)
